...
function openProduct(id) {
  ...
  const ctaFb = `<a class="btn btn-cta btn-cta-fb" href="${fb}" target="_blank" rel="noopener">
    <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.69.24 2.69.24v2.97h-1.52c-1.49 0-1.96.93-1.96 1.89v2.25h3.33l-.53 3.49h-2.8V24C19.61 23.1 24 18.1 24 12.07z"/></svg>
    Facebook
  </a>`;
  const ctaIg = CONFIG.instagram
    ? `<a class="btn btn-cta btn-cta-ig" href="${CONFIG.instagram}" target="_blank" rel="noopener">
  ...
  const ctaWa = CONFIG.whatsapp
    ? `<a class="btn btn-cta btn-cta-wa" href="https://wa.me/995${CONFIG.whatsapp.replace(/\D/g,"")}" target="_blank" rel="noopener">
...
async function migrate() {
  const CAT_MAP = { "ლეპტოპები": "ლეპტოპი" };
  let changed = false;
